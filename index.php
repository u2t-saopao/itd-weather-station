        ...
        <div class="header" style="margin-bottom: 10px; height: 100%; border-radius: 0px 0px 8px 8px;">
            ...
            <nav>
                    ...
                    <div class="col-md-5" style="margin-top: 0.5%;">
                        ...
                        <div class="row">
                        <h4  style="font-size: 17px;text-align: end; margin-top: 12px; right: 0; font-family: 'IBM Plex Sans Thai', sans-serif;">Last Update:<h4 id="date_time"
                            style="font-size: 17px;text-align: end; margin-top: 12px; right: 0; font-family: 'IBM Plex Sans Thai', sans-serif;"></h4>
                        </h4>
                        </div>
